  ...
  async ({ event, step }) => {
    ...
    await sendEmail({
      ...
      body: `
        ...
        <p style="font-size: 16px">Yo've been assigned a new task:</p>
      ...
      View Task
        ...
        <p  style="margin-top: 30px; font-size: 14px; color: #6c757d;">  Please make sure to review and complete it before the due date.</p>
        </div>
      `,
    });
